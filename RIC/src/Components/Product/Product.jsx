                ...
                <div className="product-card" key={details._id}>
                    ...
                    <div className="product-info">
                        ...
                        <div className="details-grid">
                            ...
                            <div className="detail-item">
                                <strong>Approved Status:</strong> {details.status.rera && details.status.dtcp ? "DTCP AND RERA" : details.status.dtcp ? 'DTCP' : details.status.rera ? 'RERA' : "NO DTCP AND RERA"}
                            </div>
                            <div className="detail-item">
                                <strong>Construction Status:</strong> {details.constructionStatus}
                            </div>
                            <div className="detail-item">
